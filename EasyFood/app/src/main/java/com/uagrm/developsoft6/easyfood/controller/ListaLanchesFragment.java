...
import com.uagrm.developsoft6.easyfood.model.ObjetoLanche;
...
public class ListaLanchesFragment extends android.support.v4.app.ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Toast.makeText(getActivity(), "Lanche: " + lanche.getNome() + " Preçio: " + nf.format(lanche.getPreco()), Toast.LENGTH_LONG).show();
